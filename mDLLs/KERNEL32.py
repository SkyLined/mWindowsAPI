...
KERNEL32.fDefineFunction(HANDLE,  "CreateFileA", LPCSTR, DWORD, DWORD, LPSECURITY_ATTRIBUTES, DWORD, DWORD, HANDLE);
KERNEL32.fDefineFunction(HANDLE,  "CreateFileW", LPCWSTR, DWORD, DWORD, LPSECURITY_ATTRIBUTES, DWORD, DWORD, HANDLE);
...
KERNEL32.fDefineFunction(HANDLE,  "CreateNamedPipeA", LPCSTR, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, LPSECURITY_ATTRIBUTES);
KERNEL32.fDefineFunction(HANDLE,  "CreateNamedPipeW", LPCWSTR, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, LPSECURITY_ATTRIBUTES);
