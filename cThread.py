...
#    "st7":  ("FltSave.FloatRegisters[7]", 80, 0),
    ...
    b"xmm14": ("Xmm14", 128, 0),
    b"xmm15": ("Xmm15", 128, 0),
# Ideally, we'd want to get all the available registers but there is no public
# documentation for this. Some unofficial reverse-engineered info exists but
# this suggests that implementing code to do this is non-trivial.
# See https://windows-internals.com/cet-on-windows/#6--context_ex--internals
#    b"xmm16": ("Xmm16", 128, 0),
#    b"xmm17": ("Xmm17", 128, 0),
#    b"xmm18": ("Xmm18", 128, 0),
#    b"xmm19": ("Xmm19", 128, 0),
